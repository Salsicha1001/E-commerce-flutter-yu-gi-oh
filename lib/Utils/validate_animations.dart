...
String getAnimation(name, context) {
  if (name == "exodia") {
  ...
  } else if (name == 'Earthbound Immortal Wiraqocha Rasca' ||name=='Imortal Terrestre Wiraqocha Rasca') {
    return 'https://salsicha1001.github.io/repository_images_videos/assets/animation/en/card_allasta.mp4';
  } else if (name == 'Embodiment of Apophis'|| name=='Encarnação de Apophis') {
    return 'https://salsicha1001.github.io/repository_images_videos/assets/animation/en/card_aphopis.mp4';
  } else if (name == 'Arcana Force EX - The Light Ruler' || name=='Força Arcana EX - O Governador da Luz') {
  ...
  } else if (name == 'Earthbound Immortal Aslla piscu' || name=='Imortal Terrestre Aslla piscu') {
  ...
  } else if (name == 'Black Luster Soldier'|| name=='Soldado do Lustro Negro') {
  ...
  } else if (name == 'Bloom Diva the Melodious Choir'|| name==' Diva Florescente, a Coral Melodiosa') {
    return 'https://salsicha1001.github.io/repository_images_videos/assets/animation/en/card_bloom_diva.mp4';
  } else if (name == 'Blue-Eyes White Dragon'|| name=='Dragão Branco de Olhos Azuis') {
    var rng = Random();
    List<String> videos = [
  ...
  } else if (name == 'Blue-Eyes Ultimate Dragon'|| name=='Dragão Definitivo de Olhos Azuis') {
    return 'https://salsicha1001.github.io/repository_images_videos/assets/animation/en/card_blue_eyes_ultimate_dragon.mp4';
  } else if (name == 'Blue-Eyes Alternative White Dragon'|| name=='Dragão Branco Alternativo de Olhos Azuis') {
    return 'https://salsicha1001.github.io/repository_images_videos/assets/animation/en/card_blue_eyes_alternative.mp4';
  } else if (name == 'Indiora Doom Volt the Cubic Emperor'|| name=='Indiora Volt Mortal, o Imperador Cúbico') {
    ...
    int number = rng.nextInt(videos.length);
    return videos[number];
  } else if (name == 'D/D/D Doom King Armageddon'|| name=='D/D/D Armagedom, o Rei do Fim') {
    return 'https://salsicha1001.github.io/repository_images_videos/assets/animation/en/card_ddd_king.mp4';
  } else if (name == 'Earthbound Immortal Ccapac Apu'|| name=='Imortal Terrestre Ccapac Apu') {
  ...
  } else if (name == 'The Winged Dragon of Ra'|| name=='O Dragão Alado de Rá') {
  ...
  } else if (name == 'Elemental HERO Flame Wingman'|| name=='Homem-Alado das Chamas, o HERÓI do Elemento') {
    return 'https://salsicha1001.github.io/repository_images_videos/assets/animation/en/card_elemental_hero.mp4';
  } else if (name == 'Evil HERO Malicious Fiend'|| name=='HERÓI Maligno Demônio Malicioso') {
  ...
  } else if (name == 'The Legendary Fisherman' || name=='O Pescador Lendário') {
    return 'https://salsicha1001.github.io/repository_images_videos/assets/animation/en/card_fishman.mp4';
  } else if (name == 'Galaxy-Eyes Photon Dragon'|| name=='Dragão de Fóton de Olhos das Galáxias') {
    return 'https://salsicha1001.github.io/repository_images_videos/assets/animation/en/card_galayx_eyes_dragon.mp4';
  } else if (name == 'Gandora the Dragon of Destruction'|| name=='Gandora o Dragão da Destruição') {
  ...
  } else if (name == 'Hamon, Lord of Striking Thunder'|| name=='Hamon, o Senhor do Trovão Impactante') {
    return 'https://salsicha1001.github.io/repository_images_videos/assets/animation/en/card_hamon.mp4';
  } else if (name == 'Destiny HERO - Plasma'|| name==' HERÓI do Destino - Plasma') {
    return 'https://salsicha1001.github.io/repository_images_videos/assets/animation/en/card_hero_destiny_plasma.mp4';
  } else if (name == 'Meklord Emperor Wisel'|| name=='Senhormek Imperador Wisel') {
  ...
  } else if (name == 'Number 32: Shark Drake'|| name=='Número 32: Dragonete Tubarão') {
    return 'https://salsicha1001.github.io/repository_images_videos/assets/animation/en/card_number32.mp4';
  } else if (name == 'Obelisk the Tormentor'|| name=='Obelisco, o Atormentador') {
    return 'https://salsicha1001.github.io/repository_images_videos/assets/animation/en/card_obelisk.mp4';
  } else if (name == 'Odd-Eyes Dragon'|| name=='Dragão Pêndulo de Olhos Anômalos') {
  ...
  } else if (name == 'Orgoth the Relentless'|| name=='Orgoth, o Implacável') {
  ...
  } else if (name == 'Raviel, Lord of Phantasms'|| name=='Raviel, o Senhor dos Fantasmas') {
    return 'https://salsicha1001.github.io/repository_images_videos/assets/animation/en/card_raviel.mp4';
  } else if (name == 'Red Dragon Archfiend'|| name=='Dragão Vermelho Arquidemônio') {
    return 'https://salsicha1001.github.io/repository_images_videos/assets/animation/en/card_red_dragon_arctype.mp4';
  } else if (name == 'Red-Eyes Black Dragon'|| name=='Dragão Negro de Olhos Vermelhos') {
    var rng = Random();
    List<String> videos = [
  ...
  } else if (name == 'Superheavy Samurai Big Benkei'|| name=='Samurai Superpesado Grande Benkei') {
    return 'https://salsicha1001.github.io/repository_images_videos/assets/animation/en/card_samurai_big_benkei.mp4';
  } else if (name == 'Shooting Star Dragon'|| name=='Dragão da Explosão Estelar') {
  ...
  } else if (name == 'Slifer the Sky Dragon'|| name=='Slifer, o Dragão Celeste') {
  ...
  } else if (name == 'Abyss Actor - Superstar'|| name=='Ator do Abismo - Superstar') {
  ...
  } else if (name == 'Uria, Lord of Searing Flames'|| name=='Uria, o Senhor das Chamas Cortantes') {
  ...
  } else if (name == 'Volcanic Doomfire'|| name=='Condenação de Fogo Vulcânico') {
